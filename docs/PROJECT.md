...
| Админ-панель | Сотрудники (учётки из iiko: роль, вход, привязка Telegram), должности, филиалы/бюджеты, отделы, маршруты, SLA, регламенты, доступ по ролям, чек-листы, справочники кассы (статьи прихода/расхода, ДДС, типы оплат, юрлица — общие с разделом «Деньги», изменения пишутся в журнал безопасности), система |
