...
Система управления сетью общепита: задачи и согласования, деньги и касса,
аналитика продаж из iiko, чек-листы, Telegram-бот. Построена как продаваемый
продукт с тремя уровнями управления (Back Office владельца → админка клиента →
приложение сотрудников).

## 📖 Документация

- **[docs/ARCHITECTURE.md](docs/ARCHITECTURE.md)** — устройство системы, уровни, модули, модель доступа.
- **[docs/STANDARDS.md](docs/STANDARDS.md)** — обязательные правила разработки: как добавлять функции, безопасность, миграции, процесс, проверка на ошибки.

Читать в первую очередь всем, кто присоединяется к разработке.
