...
export const MODULES = {
  ...
  production: {
    label: "Производство — автогенерация документов",
    desc: "Разворот техкарты в цепочку документов iiko (перемещения + акты), мониторы отделов с план/факт, до-задания при недостаче, конструктор заказных изделий.",
    default: false,
  },
  cvm: {
